    ...
    return (
      <footer className="text-center bg-gray-900 text-white">
        ...
        <div className="container px-6 pt-6 mx-auto">
          <img
            className="w-10 h-10 mx-auto mb-3 rounded-md"
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2">
            <div className="mb-6 mx-auto">
              <h5 className="uppercase font-bold mb-2.5">HEAD QUARTERS</h5>
            ...
            <div className="mb-6 mx-auto">
              <h5 className="uppercase font-bold mb-2.5">CENTRAL REGION</h5>
              <p className="mb-0 text-left">
              Ground Floor,Rajamally Building,
                ...
                <br></br> 
                Phone: 7594051437 /+91-481-2731050
              </p>
            </div>
            <div className="mb-6 mx-auto">
              <h5 className="uppercase font-bold mb-2.5">NORTH REGION</h5>
              <p className="mb-0 text-left">
              2nd Floor, Ul Cyberpark Building,
                ...
                Kerala, India.
                <br></br> 
                Phone: 7594051437 /+91-495-2431432
              </p>
            </div>
            <div className="mb-6 mx-auto">
              <h5 className="uppercase font-bold mb-2.5">LEGAL</h5>
              <ul className="list-none mb-0">
                <li><a href="/home">Terms & Conditions</a></li>
                <li><a href="/home">Privacy Policy</a></li>
                <li><a href="/home">Licenses (ICTAK)</a></li>
              </ul>
            </div>
        ...
        <div className="text-center p-4 bg[#00000033]">
